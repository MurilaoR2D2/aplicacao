              ...
              <?php 
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <button onclick= "return confirm('Voce deseja excluir?')" type="submit" name="/aulalogin2/views/delete_usuario/?id=<?= $usuario ['id']; ?>" class="btn btn-danger btn-sm">Excluir </button>
